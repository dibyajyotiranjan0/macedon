...
class _AddNewProductState extends State<AddNewProduct> {
  ...
  void initState() {
    ...
    print(widget.product.containsKey("sales_price"));
    if (widget.product.containsKey("sales_price")) {
      productDecreption =
  ...
  submitForm(formkey) async {
    ...
    String venderid;
    if (widget.product.containsKey("vendor_id")) {
      venderid = widget.product["vendor_id"];
    } else {
      venderid = userId!;
    }
    if (formState!.validate()) {
      ...
      selectedButton != null && catvalueAddApi.length != 0
          ? provider.ResturantEditProduct(
              ...
              ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                content: Text('your Product edit sucessfully'),
              ));
              formState.reset();
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text('You must Enter All the Details'),
      ));
    }
  }
            ...
            children: [
              ...
              SizedBox(
                  ...
                  child: ElevatedButton(
                      ...
                      onPressed: () =>
                          provider.cloading ? null : submitForm(formKey),
