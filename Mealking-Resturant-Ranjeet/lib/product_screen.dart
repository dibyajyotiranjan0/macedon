...
import 'package:mealkingresturant/add_new_product.dart';
      ...
      await provider.AddNewResurantProduct(resturant.text.toString())
        ...
        if (value["product_id"] != null) {
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            content: Text('Product added sucessfuly'),
          ));
          ...
          return Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (context) => AddNewProduct(
                        product: {
                          "product_name": resturant.text.toString(),
                          "product_id": value["product_id"]
                        }, //
                      )));
        } else {
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            content: Text('Product already available in your section'),
          ));
          Navigator.pop(context);
        }
      });
                                          ...
                                          decoration: BoxDecoration(
                                              image: DecorationImage(
                                                  ...
                                                  image: CachedNetworkImageProvider(
                                                      "https://mealking.in/uploads/${value.resturantproducts!.messages!.status!.productDtls?[index].primaryImage}")),
                                              borderRadius:
