...
import '../model/getLoationModel.dart';
import '../model/profileResturant.dart';
import '../model/resturant_area.dart';
import '../model/resturant_pin.dart';
...
class ViewProfileResturantProvider extends ChangeNotifier {
  ...
  getAllLocation() async {
    ...
    //print(productslist);
    getLocationModel = GetLocationModel.fromJson(itemList);
