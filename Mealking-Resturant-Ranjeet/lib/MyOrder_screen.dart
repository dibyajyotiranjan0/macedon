...
import 'package:mealkingresturant/veryfy_order_screen.dart';
...
class _MyOrderScreenState extends State<MyOrderScreen>
  ...
  loadSwitch() async {
    final provid = Provider.of<OffOnstsProvider>(context, listen: false);
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    String? phone = prefs.getString('phone_no');
    provid.ResturantLoginWithPhone(phone!);
                  ...
                  : va.cloading
                      ...
                      : Column(
                          children: [
                            ...
                            FittedBox(
                                child: Text(
                              "${va.resturantLogin!.messages?.status?[0].acciesType == "0" ? "Offline" : "Online"}",
