...
Widget ServicecenterSliderWidget(BuildContext context) {
  return Consumer(
    ...
    return sliderImage == null ||
            sliderImage.messages?.data?.Single_Center_Data?.length == 0
        ? Center(
        ...
        : Container(
            ...
            child: CarouselSlider(
              options: CarouselOptions(
                  ...
                  autoPlayAnimationDuration: Duration(milliseconds: 1),
                  pageSnapping: true),
              items: sliderImage.messages!.data!.Single_Center_Data!
                  .map((item) => Container(
                            decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(15),
                                image: DecorationImage(
                                    ...
                                    image: CachedNetworkImageProvider(
                                        "${AppUrl.imageUrl}${item.centerimage}"))),
                          )
                      //  Image.network(
                      //       item,
                      //       fit: BoxFit.fill,
