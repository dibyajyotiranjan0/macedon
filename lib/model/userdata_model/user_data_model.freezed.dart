...
class _$UserdataModelImpl implements _UserdataModel {
  const _$UserdataModelImpl({this.status, this.error, this.messages});
  ...
  @override
  String toString() {
    return 'UserdataModel(status: $status, error: $error, messages: $messages)';
  }
...
abstract class _UserdataModel implements UserdataModel {
  const factory _UserdataModel(
      {final int? status,
      final bool? error,
      final Messages? messages}) = _$UserdataModelImpl;
...
class _$StatusImpl implements _Status {
  const _$StatusImpl(
      {this.user_id, this.fullname, this.email, this.contact, this.isLoggedIn});
  ...
  @override
  String toString() {
    return 'Status(user_id: $user_id, fullname: $fullname, email: $email, contact: $contact, isLoggedIn: $isLoggedIn)';
  }
...
abstract class _Status implements Status {
  const factory _Status(
      ...
      final dynamic email,
      final String? contact,
      final bool? isLoggedIn}) = _$StatusImpl;
